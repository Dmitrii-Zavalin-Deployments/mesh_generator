...
def test_get_min_feature_size_edge_detection():
    with patch("src.steps.resolution.TopExp_Explorer") as mock_explorer, \
        ...
        assert get_min_feature_size(TopoDS_Shape()) == 2.0
